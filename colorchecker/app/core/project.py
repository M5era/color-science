...
class ImageEntry:
    ...
    # Per-frame corner positions: overlay name -> [TL, TR, BR, BL] used
    # for THIS frame only (a shot that shifted against the others).
    # Absent name = frame follows the shared overlay position.
